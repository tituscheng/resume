...
\name{Titus}{Cheng}
\address{20831 29th Ave SE, Bothell WA 98021}
\mobile{(425) 305-6551}
...
\makecvfooter{\today}{Titus Cheng~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
